...
import 'package:registro_ponto_frontend/features/colaborador/presentation/views/colaborador_dashboard_body.dart';
import 'package:registro_ponto_frontend/features/colaborador/presentation/widgets/nav_tabs.dart';
...
class ColaboradorShellLoaded extends ConsumerStatefulWidget {
  final ColaboradorProfile profile;

  const ColaboradorShellLoaded({super.key, required this.profile});

  @override
  ConsumerState<ColaboradorShellLoaded> createState() => _ColaboradorShellLoadedState();
}

class _ColaboradorShellLoadedState extends ConsumerState<ColaboradorShellLoaded> {
  int _tabIndex = 0;
        ...
        children: [
          ...
          Expanded(
            child: IndexedStack(
              index: _tabIndex,
              children: [
                ColaboradorDashboardBody(profile: profile),
                const AppDeveloping(),
                const AppDeveloping(),
              ],
            ),
